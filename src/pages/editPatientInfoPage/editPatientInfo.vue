<template>
  ...
  <AtInput
    ...
    <AtInput
      ...
      required
    />
    <Picker class="picker" mode='selector' :range='genderSelector' :onChange='onChangeGender.bind(this)'>
      <AtList>
        <AtListItem
          title='患者性别'
  ...
  >
    ...
    />
    <Picker class="picker" mode='selector' :range='relationSelector' :onChange='onChangeRelation.bind(this)'>
      <AtList>
        <AtListItem
          title='关系'
    ...
    <Picker class="picker" mode='selector' :range='livingSelector' :onChange='onChangeLiving.bind(this)'>
      <AtList>
        <AtListItem
          title='是否独居'
...
<script setup>
  ...
  import { set as setGlobalData, get as getGlobalData, set } from "../../utils/global_data"
  ...
  // 其他信息
  let relationSelector = ['子女','子孙','近亲属','邻居','社区工作人员','养老院工作人员','其他']
