<template>
  ...
  <button class="avatar" open-type="chooseAvatar" :onChooseavatar="onChooseAvatar.bind(this)">
    <image :src="userInfo.avatar" style="display: block; width: 100%;height: 100%;"></image>
  </button>
  <AtInput
    class="item"
